...
<head>
    ...
    <title>Halaman Tambah Pemasok</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 bg-primary">
                            <h6 class="m-0 font-weight-bold text-light">Tambah Data Pemasok</h6>
                        </div>
                        <div class="card-body">
                            <!-- Begin Form-->
                            <form action="proses_tambah.php" method="post" onsubmit="return validateForm()">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_pemasok" placeholder="Masukan nama pemasok" name="nama_pemasok">
                                </div>
                                <div class="mb-3">
                                    <label for="no_hp" class="form-label">No. HP</label>
                                    <input type="tel" class="form-control" id="no_hp" placeholder="Masukan nomer handphone pemasok" name="no_hp">
                                </div>
                                <div class="mb-3">
                                    <label for="alamat" class="form-label">Alamat</label>
                                    <input type="text-area" class="form-control" id="alamat" placeholder="Masukan alamat pemasok" name="alamat">
                                </div>

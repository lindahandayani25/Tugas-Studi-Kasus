...
<head>
    ...
    <title>Halaman Edit Kategori Produk</title>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                        <div class="card-header py-3 bg-primary">
                            <h6 class="m-0 font-weight-bold text-light">Edit Data Kategori</h6>
                        </div>
                        <div class="card-body">
                            <?php
                            include '../koneksi.php';
                            ...
                            ?>
                            <!-- Begin Form-->
                            <form action="proses_edit.php?id_kategori=<?php echo $id_kategori ?>" method="post" onsubmit="return validateForm()">
                                <div class="mb-3">
                                    <label for="id_kategori" class="form-label">ID Kategori</label>
                                    <input type="number" class="form-control" id="id_kategori" name="id_kategori" disabled value="<?php echo $id_kategori ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="nama_kategori" class="form-label">Nama Kategori</label>
                                    <input type="text" class="form-control" id="nama_kategori" placeholder="Masukan nama kategori" name="nama_kategori" value="<?php echo $nama_kategori ?>">
                                </div>

...
<head>
	...
	<title>Jaya Abadi | Homepage</title>
</head>
<body>
			...
			<div class="container">
				<div class="row justify-content-center align-items-center pad-tab" data-aos="fade-up">
					<div class="banner-text col-sm-12 col-md-6">
						<p class="text-second">Selamat datang di katalog toko sembako kami!</p>
						<h1 class="text-main secondary-col">Koleksi Lengkap & Berkualitas
						</h1>
					...
					<div class="banner-image col-sm-12 col-md-6 d-none d-sm-block">
						<img src="assets/images/logo.png" alt="image-banner" class="img-fluid" width="500px">
					</div>
				</div>
			</div>
		</section>

...
<head>
    ...
    <title>Halaman Tambah Harga Produk</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 bg-primary">
                            <h6 class="m-0 font-weight-bold text-light">Tambah Data Harga</h6>
                        </div>
                        <div class="card-body">
                            <?php
                            include '../koneksi.php';
                            ...
                            <form action="proses_tambah.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="harga_beli" placeholder="Masukan harga beli produk" name="harga_beli">
                                </div>
                                <div class="mb-3">
                                    <label for="harga_jual" class="form-label">Harga Jual</label>
                                    <input type="number" class="form-control" id="harga_jual" placeholder="Masukan harga jual produk" name="harga_jual">
                                </div>
